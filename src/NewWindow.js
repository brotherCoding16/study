...
const NewWindow = (props) => {
  ...
  const handleJoinMeet = () => {
    ...
    if(props.pass==="mahdir10") window.open("https://meet.google.com/hyi-okwm-usg", '_blank');
    ...
    if(props.pass==="afsana10") window.open("https://meet.google.com/ovh-zqcc-sns", '_blank');
  };
