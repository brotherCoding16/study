...
const NewWindow = (props) => {
  ...
  const handleJoinMeet = () => {
    ...
    if(props.pass==="afsana10") window.open("https://meet.google.com/izu-cmzz-nzq", '_blank');
    if(props.pass==="abir10") window.open("https://meet.google.com/zqj-eiet-wyf", '_blank');
  };
