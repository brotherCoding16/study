...
const NewWindow = (props) => {
  ...
  const handleJoinMeet = () => {
    ...
    if(props.pass==="mahdir10") window.open("https://meet.google.com/iyo-fcev-rwz", '_blank');
    ...
    if(props.pass==="afsana10") window.open("https://meet.google.com/cdx-pdaa-tmp", '_blank');
  };
